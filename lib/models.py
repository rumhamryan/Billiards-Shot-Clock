...
class Game_Stats:
    def __init__(  # noqa: PLR0913
        self,
        profile_based_countdown=0,
        countdown=0,
        extension_duration=0,
        extension_available=True,
        extension_used=False,
        player_1_shooting=True,
        player_1_extension_available=True,
        player_2_shooting=False,
        player_2_extension_available=True,
        inning_counter=1.0,
        rack_counter=1,
        break_shot=True,
        speaker_muted=False,
        ...
        profile_selection_index=0,
        temp_setting_value=None,
    ):  # noqa: PLR0913
        ...
        self.menu_values = menu_values or [
            rack_counter,
            speaker_muted,
            int(inning_counter),
        ]
        self.current_menu_index = current_menu_index
        self.current_menu_selection = current_menu_selection or [
            None,
            self.menu_items[current_menu_index],
            None,
        ]
        self.current_menu_values = current_menu_values or [
            None,
            self.menu_values[current_menu_index],
            None,
        ]
